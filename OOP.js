    ...
    for (let number of numbers) {
        if (/^\d+\.$/.test(number.innerText)) {
            ...
            if (number.innerText == "1.") {
                ...
                child.innerHTML += java_icon_svg; 
                child.innerHTML += " Main.java";
